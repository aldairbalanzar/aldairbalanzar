...
const About = () => {
    const content = ['My name is Aldair Balanzar and I am an avid full stack web-developer that finds satisfaction in creating solutions throughout the web, wether it be a simple CSS animation or data structure, I will shoot for excellence.',
    'My background is in special education and I owe it to this experience as to why I took the dive into web-development and computer science, it was at the school that I worked at where I built my first application.',
